...
Variable No. 1 (Column 1): activity
This variable contains numbers from 1 to 6; each number is an ID of the activity:
ID	Activity
1            WALKING
2   	WALKING_UPSTAIRS
...
Variable No. 2 (Column 2): Subject
This variable contains numbers from 1 to 30; each number is an ID for a volunteer doing the test or train.

Variable No. 3 (Column 3): Average
This variable contains the average for this variable name (see No. 4); for an activity and a particular volunteer.

Variable No. 4 (Column 4): Variable
This variable contains the name of the measured variable; there are 561 possible names.
...
Variable No. 5 (Column 5): activity
This variable contains the activity label:
ID	Activity
1            WALKING
2   	WALKING_UPSTAIRS
3	WALKING_DOWNSTAIRS
